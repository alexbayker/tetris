        ...
        synchronized (GUI.logic)
        {
            ...
            else if (moved == 1)
            {
                if (squares[2].y > -1 &&
                        ...
                        GUI.logic.getFromArray(squares[1].x, squares[1].y - 1) == ' ' &&
                        GUI.logic.getFromArray(squares[0].x, squares[0].y - 1) == ' ')
                {
                    GUI.logic.setInArray(squares[0], ' ');
                    GUI.logic.setInArray(squares[2], ' ');
                    GUI.logic.setInArray(squares[3], ' ');
    ...
    public synchronized int stepsToDown()
    {
        synchronized (GUI.logic)
        {
            ...
            if (moved == 0)
            {
                ...
                {
                    if (GUI.logic.getFromArray(squares[2].x, y) == ' ' &&
            ...
            {
                for (int ybig = squares[0].y + 1, ymin = squares[2].y + 1; ybig < 20; ybig++, ymin++) {
                    if (GUI.logic.getFromArray(squares[0].x, ybig) == ' ' &&
                            GUI.logic.getFromArray(squares[2].x, ymin) == ' ')
                        count++;
                    else
                        return count;
                }
            ...
            {
                for (int ybig = squares[2].y + 1, ymin = squares[0].y + 1; ybig < 20; ybig++, ymin++)
                {
                    if (GUI.logic.getFromArray(squares[0].x, ymin) == ' ' &&
                            GUI.logic.getFromArray(squares[1].x, ymin) == ' ' &&
                            GUI.logic.getFromArray(squares[2].x, ybig) == ' ')
                        count++;
                    else
                        return count;
                }
